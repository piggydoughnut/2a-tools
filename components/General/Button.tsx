...
export const DownloadLink = ({
  ...
  <a
    className="p-4 bg-green-200 border rounded-md text-md ease-in-out duration-30 w-44 hover:bg-transparent hover:text-green-800 hover:border-green-800 text-center"
    href={url}
    download={fileName}
  >
    {title}
